...
// packages/interact-local/src/interact/data/) into the extension's src/ so resolveJsonModule can bundle it.
...
const from = path.resolve(__dirname, "../../../packages/interact-local/src/interact/data");
