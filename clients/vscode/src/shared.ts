...
// Canonical types — generated from packages/interact-local/src/interact/api_types.py.
...
// package (packages/interact-local/src/interact/data/settings.json, regenerated by `python -m interact.config.schema`),
